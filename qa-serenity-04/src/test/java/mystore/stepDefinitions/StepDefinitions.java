...
public class StepDefinitions {
    /*
    Here we create the gherkin steps in order to
    create later our features.
    In case of not using Cucumber,
    we should define the specific tests
    (here we use Cucumber, so we define the stepDefinitions)
    */
